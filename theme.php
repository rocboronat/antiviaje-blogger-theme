...
<link href='https://fewlaps.com/xtra/antiviaje/apple-icon-57x57.png' rel='apple-touch-icon' sizes='57x57'/>
<link href='https://fewlaps.com/xtra/antiviaje/apple-icon-60x60.png' rel='apple-touch-icon' sizes='60x60'/>
<link href='https://fewlaps.com/xtra/antiviaje/apple-icon-72x72.png' rel='apple-touch-icon' sizes='72x72'/>
<link href='https://fewlaps.com/xtra/antiviaje/apple-icon-76x76.png' rel='apple-touch-icon' sizes='76x76'/>
<link href='https://fewlaps.com/xtra/antiviaje/apple-icon-114x114.png' rel='apple-touch-icon' sizes='114x114'/>
<link href='https://fewlaps.com/xtra/antiviaje/apple-icon-120x120.png' rel='apple-touch-icon' sizes='120x120'/>
<link href='https://fewlaps.com/xtra/antiviaje/apple-icon-144x144.png' rel='apple-touch-icon' sizes='144x144'/>
<link href='https://fewlaps.com/xtra/antiviaje/apple-icon-152x152.png' rel='apple-touch-icon' sizes='152x152'/>
<link href='https://fewlaps.com/xtra/antiviaje/apple-icon-180x180.png' rel='apple-touch-icon' sizes='180x180'/>
<link href='https://fewlaps.com/xtra/antiviaje/android-icon-192x192.png' rel='icon' sizes='192x192' type='image/png'/>
<link href='https://fewlaps.com/xtra/antiviaje/favicon-32x32.png' rel='icon' sizes='32x32' type='image/png'/>
<link href='https://fewlaps.com/xtra/antiviaje/favicon-96x96.png' rel='icon' sizes='96x96' type='image/png'/>
<link href='https://fewlaps.com/xtra/antiviaje/favicon-16x16.png' rel='icon' sizes='16x16' type='image/png'/>
<link href='https://fewlaps.com/xtra/antiviaje/manifest.json' rel='manifest'/>
<meta content='#ffffff' name='msapplication-TileColor'/>
<meta content='https://fewlaps.com/xtra/antiviaje/ms-icon-144x144.png' name='msapplication-TileImage'/>
...
<b:else/>
<title>404: La página se ha ido de viaje</title>
</b:if>
</b:if>

<script async='async' src='https://www.googletagmanager.com/gtag/js?id=UA-112510707-1'/>
<script>
...
<b:section class='headersec' id='headersec' maxwidgets='1' showaddelement='no'>
  <b:widget id='Header1' locked='true' title='ANTI-VIAJE (cabecera)' type='Header' version='1'>
    <b:widget-settings>
...
<b:section class='nbttopmenutop' id='nbttopmenutop' maxwidgets='1' showaddelement='no'>
  <b:widget id='PageList8' locked='false' title='Pages - Menu' type='PageList' version='1'>
    <b:widget-settings>
      <b:widget-setting name='pageListJson'><![CDATA[{'home': {'href': 'https://www.antiviaje.com/', 'title': 'Blog', 'position': 0}, 'link0': {'href': 'https://www.antiviaje.com/p/paises-por-los-que-hemos-pasado.html', 'title': 'Países', 'position': 1}, 'link1': {'href': 'https://www.antiviaje.com/p/diario.html', 'title': 'Diario', 'position': 2}, 'link2': {'href': 'https://www.antiviaje.com/p/nosotros.html', 'title': 'Nosotros', 'position': 3}}]]></b:widget-setting>
      <b:widget-setting name='homeTitle'>Blog</b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
                ...
                <ul class='nav-barpbt' id='menu-testing-menu'>
                  <b:loop values='data:links' var='link'>
                    <b:if cond='data:link.isCurrentPage'>
                      <li id='currentpage' style='font-weight: bold;'><a expr:href='data:link.href'><data:link.title/></a></li>
                    <b:else/>
...
<b:section class='mainblogsec' id='mainblogsec' showaddelement='no'>
  <b:widget id='HTML2' locked='false' title='' type='HTML'>
    <b:widget-settings>
      <b:widget-setting name='content'><![CDATA[<!-- LightWidget WIDGET --><script src="//lightwidget.com/widgets/lightwidget.js"></script><iframe src="//lightwidget.com/widgets/98848c81d5b75985a14700911aa93e26.html" scrolling="no" allowtransparency="true" class="lightwidget-widget" style="width: 100%; height: 114px; border: 0; overflow: hidden; margin-bottom: 30px"></iframe>]]></b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
    ...
    <div class='blog-posts hfeed'>
      ...
      <b:loop values='data:posts' var='post'>
        ...
        <b:if cond='data:post.location'>
          <h2 class='location-header'><span><data:post.location.name/></span></h2>
        </b:if>
...
-->
  ...
  <div class='blog-pager' id='blog-pager'>
    <b:if cond='data:newerPageUrl'>
      ...
      <a class='blog-pager-newer-link' expr:href='data:newerPageUrl' expr:id='data:widget.instanceId + &quot;_blog-pager-newer-link&quot;' expr:title='data:newerPageTitle'>Siguiente post</a>
      </span>
    </b:if>

    <b:if cond='data:olderPageUrl'>
      <span id='blog-pager-older-link'>
      <a class='blog-pager-older-link' expr:href='data:olderPageUrl' expr:id='data:widget.instanceId + &quot;_blog-pager-older-link&quot;' expr:title='data:olderPageTitle'>Post anterior</a>
      </span>
    </b:if>
...
<div class='entry-meta top'>
  <span class='entry-date'><a expr:href='data:post.url'><data:post.timestamp/></a></span><br/>
  <span class='entry-location'><a expr:href='data:post.location.mapsUrl' target='_blank'><data:post.location.name/></a></span>
</div><!-- .entry-meta -->
</b:if>
</header>
...
<b:if cond='data:blog.pageType == &quot;item&quot;'>
  ...
  <br/><br/><br/>
<center>
  <span style='color: #999;'>Este post lo hemos escrito en <data:post.location.name/></span>
  <br/><br/>
  <img expr:src='&quot;https://maps.googleapis.com/maps/api/staticmap?markers=&quot; +   data:post.location.name + &quot; &amp;size=540x333 &amp;zoom=7 &amp;scale=2 &amp;language=es &amp;key=AIzaSyBJil85G9eJFhIPvh2mkXGfTNGEWETqAMk&quot;' height='222' width='360'/><img expr:src='&quot;https://maps.googleapis.com/maps/api/staticmap?markers=&quot; +   data:post.location.name + &quot; &amp;size=540x333 &amp;zoom=1 &amp;scale=2 &amp;language=es &amp;center=0,0 &amp;key=AIzaSyBJil85G9eJFhIPvh2mkXGfTNGEWETqAMk&quot;' height='222' width='360'/>
  </center>
</b:if>
...
<b:if cond='data:post.labels'><span class='cat-linkspbt'>Ver más posts sobre <b:loop values='data:post.labels' var='label'><a expr:href='data:label.url' rel='tag'><data:label.name/></a><b:if cond='data:label.isLast != &quot;true&quot;'>, </b:if></b:loop></span><span class='sep'> / </span></b:if>
  ...
  <b:if cond='data:post.numComments &gt;= 1'>
    ...
    <span class='comments-linkpbt'>
      <a expr:href='data:post.addCommentUrl' expr:onclick='data:post.addCommentOnclick'>
        <b:if cond='data:post.numComments == 0'>Sin comentarios</b:if>
        <b:if cond='data:post.numComments == 1'>1 comentario</b:if>
        <b:if cond='data:post.numComments &gt;= 2'><data:post.numComments/> comentarios</b:if>
      </a>
    </span>
  </b:if>
</b:if>
...
<b:include name='nextprev'/>
  ...
  <b:if cond='data:post.editUrl'>
    <span expr:class='&quot;item-control &quot; + data:post.adminClass'>
      <span class='sep'> / </span><a expr:href='data:post.editUrl' expr:title='data:top.editPostMsg'>Editar</a>
    </span>
  </b:if>
</b:includable>
  ...
  <div class='status-msg-wrap'>
    ...
    <div class='status-msg-border-DISABLED-BY-ROC'>
      <div class='status-msg-bg-DISABLED-BY-ROC'>
...
// ]]>
  ...
  <b:widget id='Navbar1' locked='false' title='Barra de navegación' type='Navbar'>
      ...
      gapi.load(&quot;gapi.iframes:gapi.iframes.style.bubble&quot;, function() {
        if (gapi.iframes &amp;&amp; gapi.iframes.getContext) {
          gapi.iframes.getContext().openChild({
              url: &#39;https://www.blogger.com/navbar.g?targetBlogID\x3d2205734361221089334\x26blogName\x3dANTI-VIAJE\x26publishMode\x3dPUBLISH_MODE_HOSTED\x26navbarType\x3dDISABLED\x26layoutType\x3dLAYOUTS\x26searchRoot\x3dhttps://www.antiviaje.com/search\x26blogLocale\x3des\x26v\x3d2\x26homepageUrl\x3dhttps://www.antiviaje.com/\x26vt\x3d8057866696516229500&#39;,
...
<div class='sidebar-buttonpbt'><i class='fa fa-plus'/></div>
...
<form expr:action='data:blog.homepageUrl + &quot;search/&quot;' id='searchform' method='get' role='search'>
...
<b:section class='footersec' id='footersec1' showaddelement='yes'>
  <b:widget id='Label1' locked='false' title='Posts por país' type='Label' version='1'>
    <b:widget-settings>
  ...
  <b:widget id='BlogArchive1' locked='false' title='Posts por fecha' type='BlogArchive' version='1'>
    <b:widget-settings>
  ...
  <b:widget id='Stats1' locked='false' title='Contador de visitas' type='Stats'>
    <b:widget-settings>
  ...
  <b:widget id='Text1' locked='false' title='' type='Text'>
    <b:widget-settings>
      <b:widget-setting name='content'><![CDATA[<br /><center>Escrito con mucho amor por Anna y Roc<br/>❤️</center>]]></b:widget-setting>
    </b:widget-settings>
    <b:includable id='main'>
  <!-- only display title if it's non-empty -->
  <b:if cond='data:title != &quot;&quot;'>
...
<div id='gotoppbt'><h6><i class='fa fa-arrow-up'/></h6></div>

	<span style='color:#666666;'>ANTI-VIAJE</span> Anna y Roc están dando la vuelta al mundo<br/>

	<span style='color:#666666;'>Copyleft</span> <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script> <a expr:href='data:blog.homepageUrl'><data:blog.title/></a><br/>

	<span style='color:#666666;'>Open Source</span> Blogger theme at <a href='https://github.com/rocboronat/antiviaje-blogger-theme'>GitHub</a>
